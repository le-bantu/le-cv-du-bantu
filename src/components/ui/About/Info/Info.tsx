...
export const Info = component$(() => {
  return (
    ...
    class="slide-in-blur-right info flex flex-col items-center gap-4 rounded-xl h-fit border border-gray-100 bg-white dark:bg-[#1a1a1a] p-4 sticky top-[5rem] lg:w-1/4">
